...
from flask import Flask, session, redirect, jsonify, url_for, render_template, request, flash
...
def create_app():
    ...
    app.config["SESSION_FILE_DIR"] = "/tmp/flask_session" # Ensure this dir exists and is writable
    app.config["SESSION_FILE_THRESHOLD"] = 500
    app.config["SESSION_FILE_MODE"] = 0o600 # Use octal literal
    app.config['UPLOAD_FOLDER'] = os.getenv("UPLOAD_FOLDER", "/tmp/uploads") # Provide default
